...
Ausgabe:
Die Ausgabe sind jsons beringten Tweets zum Suchwort Covid
...
def clean(file_list):
    ...
    with open(os.getcwd() + r'\Datengewinnung\final_tweets_de_splitted\corona.json'+'\\'+ file_list, 'r', encoding='utf-8') as f:
            tweets = json.load(f)
    ...
    with open(os.getcwd() + r"\Datengewinnung\final_tweets_de_clean\\corona.json\\"+ re.sub(r'json',"",file_list), 'w', encoding='utf-8') as f:
...
if __name__ == "__main__":
    ...
    directory = os.getcwd() + r'\Datengewinnung\final_tweets_de_splitted\corona.json'
    path= os.getcwd() + r'\Datengewinnung\final_tweets_de_splitted\\corona.json'
